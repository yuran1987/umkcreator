# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-11-07 14:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weeks_count_in_semestr', models.CharField(blank=True, help_text='Формат: 17,18', max_length=20, null=True, verbose_name='Количество недель в семестре')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime_changed', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Дата изменения')),
                ('status', models.CharField(choices=[['edit', 'Наполнение'], ['signaturing', 'На подписи'], ['confirmed', 'Подписана'], ['empty', 'Пустая']], default='empty', max_length=50, verbose_name='Статус')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kursovya_hours', models.PositiveIntegerField(default=0, verbose_name='Количество часов на курсовую работу,часов')),
                ('kursovya_semestr', models.CharField(default='0', max_length=15, verbose_name='Номер cеместра на курсовую')),
                ('raschetnograp_work_hours', models.PositiveIntegerField(default=0, verbose_name='Количество часов на расчетно-графическую работу, часов')),
                ('raschetnograp_work_semestr', models.CharField(default='0', max_length=15, verbose_name='Номер семестра на расчетно-графическую работу')),
                ...
                ('database_info_system', models.TextField(blank=True, null=True, verbose_name='Базы данных, информационно-справочные и поисковые системы')),
                ('umk_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.UmkArticles', verbose_name='ID рабочей программы')),
            ],
            options={
